...
export function GithubIcon({ className = "w-4 h-4", size }: IconProps) {
  return (
    <svg
      className={className}
...
export function LinkedinIcon({ className = "w-4 h-4", size }: IconProps) {
  return (
    <svg
      className={className}
      style={size ? { width: size, height: size } : undefined}
...
export function MailIcon({ className = "w-4 h-4", size }: IconProps) {
  return (
    <svg
      className={className}
      style={size ? { width: size, height: size } : undefined}
...
export function ArrowUpRightIcon({ className = "w-3.5 h-3.5", size }: IconProps) {
  return (
    <svg
      className={className}
      style={size ? { width: size, height: size } : undefined}
